...
export const moldingEquipmentConfig = [
  '射出成形機',
  '取出機',
  '乾燥機',
  '温調機',
...
export const clampingForceConfig = [
  `10t未満`,
  `10t〜49t`,
  `50t〜99t`,
  `100t〜249t`,
...
export const isPrototypeMoldingMachineConfig = [
  `試作成形機あり`,
  `試作成形機なし`,
];
...
export const industryTypeConfig = [
  `家電`,
  `自動車`,
  `OA通信`,
  `電子部品`,
